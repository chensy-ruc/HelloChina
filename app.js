const uiContent = {
  en: {
    ...
    footerText: "Reach us by phone, email, or WeChat group for collaboration, feedback, and travel service ideas.",
    footerPhone: "Phone",
    footerEmail: "Email",
    footerQrLabel: "WeChat Group",
    footerQrCaption: "Scan to join the group",
  ...
  zh: {
    ...
    footerText: "欢迎通过电话、邮箱或微信群联系我们，交流项目合作、使用反馈与旅行服务建议。",
    footerPhone: "电话",
    footerEmail: "邮箱",
    footerQrLabel: "微信群聊",
    footerQrCaption: "扫码加入微信群聊",
  ...
  ja: {
    ...
    footerText: "協力、フィードバック、旅行サービスの相談は、電話・メール・WeChatグループからご連絡ください。",
    footerPhone: "電話",
    footerEmail: "メール",
    footerQrLabel: "WeChatグループ",
    footerQrCaption: "スキャンしてグループに参加",
  ...
  ko: {
    ...
    footerText: "협업, 피드백, 여행 서비스 제안은 전화, 이메일 또는 WeChat 그룹으로 문의해 주세요.",
    footerPhone: "전화",
    footerEmail: "이메일",
    footerQrLabel: "WeChat 그룹",
    footerQrCaption: "스캔하여 그룹 참여",
  ...
  es: {
    ...
    footerText: "Escríbenos por teléfono, correo o grupo de WeChat para colaboración, comentarios e ideas de servicios de viaje.",
    footerPhone: "Teléfono",
    footerEmail: "Correo",
    footerQrLabel: "Grupo WeChat",
    footerQrCaption: "Escanea para unirte al grupo",
  ...
  fr: {
    ...
    footerText: "Contactez-nous par téléphone, e-mail ou groupe WeChat pour collaborer, donner un avis ou proposer des idées de services de voyage.",
    footerPhone: "Téléphone",
    footerEmail: "E-mail",
    footerQrLabel: "Groupe WeChat",
    footerQrCaption: "Scannez pour rejoindre le groupe",
  ...
  ar: {
    ...
    footerText: "تواصل معنا عبر الهاتف أو البريد الإلكتروني أو مجموعة WeChat للتعاون والملاحظات وأفكار خدمات السفر.",
    footerPhone: "الهاتف",
    footerEmail: "البريد الإلكتروني",
    footerQrLabel: "مجموعة WeChat",
    footerQrCaption: "امسح الرمز للانضمام إلى المجموعة",
