const uiContent = {
  en: {
    ...
    showcaseEyebrow: "Mobile travel guide",
    showcaseTitle: "Scan before you explore China",
    showcaseText:
      "Open HelloChina on your phone to choose a city, follow maps, check attractions, compare weather, find food, and ask the AI guide while you travel.",
    showcaseUrlLabel: "Mobile guide",
    showcaseQrCaption: "Scan before you set out",
    ...
    footerEyebrow: "Producer Contact",
    footerTitle: "HelloChina producer contact",
    footerText: "Reach us by phone or email for collaboration, feedback, and travel service ideas.",
    footerPhone: "Phone",
    footerEmail: "Email",
    volunteerEyebrow: "Volunteer Network",
    volunteerTitle: "Help international friends explore China with confidence",
    volunteerText:
      "Join HelloChina as a city buddy, language helper, or route tester. Every contribution helps make the guide clearer, warmer, and easier to use.",
    volunteerAName: "Volunteer A",
    volunteerALangs: "English · Japanese",
    volunteerAText: "Outgoing English and Japanese speaker who loves conversation. After an exchange in the United States, A can help visitors adapt quickly while exploring local life, street snacks, and small shops.",
    volunteerBName: "Volunteer B",
    volunteerBLangs: "English · Spanish",
    volunteerBText: "Warm, talkative English and Spanish speaker with strong football skills and deep interest in football culture. B keeps the trip energetic and can even take you to experience Chinese campus football.",
    volunteerCName: "Volunteer C",
    volunteerCLangs: "Spanish",
    volunteerCText: "A junior Spanish major who is cheerful and patient. C can explain real street life, night-market food, old districts, and historical stories in fluent Spanish at an easy pace.",
    volunteerDName: "Volunteer D",
    volunteerDLangs: "English",
    volunteerDText: "A junior English major with standard pronunciation and clear expression. D enjoys alleys, local breakfasts, morning markets, and the hidden jokes behind Chinese signs.",
    volunteerEName: "Volunteer E",
    volunteerELangs: "English · Spanish",
    volunteerEText: "English and Spanish speaker with stamina and a strong sense of direction, ideal for hiking, cycling, and niche routes. E introduces geology, plants, hutongs, and countryside stories on the way.",
    volunteerFName: "Volunteer F",
    volunteerFLangs: "English",
    volunteerFText: "English speaker who turns complex history into simple, interesting stories. F is patient, cheerful, good at photos, and great for ancient architecture, legends, and modern city change.",
    volunteerGName: "Volunteer G",
    volunteerGLangs: "English",
    volunteerGText: "A junior English major who loves the outdoors and history. G specializes in off-the-beaten-path routes, from wild Great Wall walks to quiet temples and tea under the mountains.",
    volunteerHName: "Volunteer H",
    volunteerHLangs: "English",
    volunteerHText: "Fluent English speaker with a gentle and careful style. H is a strong fit for families, seniors, and relaxed trips, and can help coordinate dining, shopping, and other details.",
    volunteerCtaTitle: "Want to join?",
    volunteerCtaText: "Contact the producer team and tell us your city, language, and preferred volunteer role",
    volunteerCtaPhone: "Call us",
    volunteerCtaEmail: "Email us",
  ...
  zh: {
    ...
    statLanguages: "界面语言",
    heroPill: "地图 + 图库",
    showcaseEyebrow: "手机旅行导览",
    showcaseTitle: "出发前扫码，边走边看中国",
    showcaseText:
      "用手机打开 HelloChina 后，可以选择城市、查看地图与景点、比较天气、寻找美食，并随时向 AI 地陪提问。",
    showcaseUrlLabel: "手机导览",
    showcaseQrCaption: "出发前扫码打开",
    ...
    footerEyebrow: "制作方联系",
    footerTitle: "HelloChina 制作方联系方式",
    footerText: "欢迎通过电话或邮箱联系我们，交流项目合作、使用反馈与旅行服务建议。",
    footerPhone: "电话",
    footerEmail: "邮箱",
    volunteerEyebrow: "志愿者网络",
    volunteerTitle: "帮助国际友人自信地探索中国",
    volunteerText: "加入 HelloChina，成为城市伙伴、语言协作者或路线体验官。每一份反馈都能让导览更清晰、更友好、更好用。",
    volunteerAName: "志愿者 A",
    volunteerALangs: "英语 · 日语",
    volunteerAText: "擅长英语和日语，性格开朗、喜欢聊天。曾去美国交换，能讲地道英语，也能带你深入了解当地生活方式、街头小吃和有趣小店，帮助你快速适应这里。",
    volunteerBName: "志愿者 B",
    volunteerBLangs: "英语 · 西班牙语",
    volunteerBText: "擅长英语、西班牙语，热情爱笑、全程有活力。热爱足球，对足球文化很了解，足球水平也高，可以带你体验中国校园足球文化，愿意的话还能一起踢球。",
    volunteerCName: "志愿者 C",
    volunteerCLangs: "西班牙语",
    volunteerCText: "西班牙语专业大三学生，开朗耐心。能用流利西语讲解真正的市井生活、地道夜市小吃、老城区和历史故事，节奏不快不慢，帮助你听懂、玩透。",
    volunteerDName: "志愿者 D",
    volunteerDLangs: "英语",
    volunteerDText: "英语专业大三学生，口音标准、表达清晰。喜欢带外国朋友走街串巷、尝本地早餐、逛晨间菜市场，也会解释中文招牌里的“彩蛋”，专业又风趣。",
    volunteerEName: "志愿者 E",
    volunteerELangs: "英语 · 西班牙语",
    volunteerEText: "擅长英语、西班牙语，体力好、方向感强。特别适合带喜欢徒步、骑行和小众路线的游客，会边爬山、逛胡同，边介绍中国的地质、植物和乡村故事。",
    volunteerFName: "志愿者 F",
    volunteerFLangs: "英语",
    volunteerFText: "擅长英语，也擅长用简单有趣的英文讲复杂历史。适合对古建筑、神话传说和现代城市变迁感兴趣的游客；耐心爱笑，也很会拍照。",
    volunteerGName: "志愿者 G",
    volunteerGLangs: "英语",
    volunteerGText: "英语专业大三学生，喜欢户外和历史，擅长带外国朋友走小众路线。如果你不想挤景点，可以一起爬野长城、逛安静古寺，在山脚喝茶听中国故事。",
    volunteerHName: "志愿者 H",
    volunteerHLangs: "英语",
    volunteerHText: "英语口语流利，性格温柔细心。适合带孩子或老人同行的游客，也适合不赶路的轻松行程；会用简单清楚的英文讲故事，并帮忙协调餐饮、购物等细节。",
    volunteerCtaTitle: "想加入？",
    volunteerCtaText: "请联系制作方，并告诉我们你的城市、语言和想参与的志愿者角色",
    volunteerCtaPhone: "电话联系",
    volunteerCtaEmail: "邮件联系",
  ...
  ja: {
    ...
    statLanguages: "UI言語",
    heroPill: "地図 + ギャラリー",
    showcaseEyebrow: "スマホ旅行ガイド",
    showcaseTitle: "中国を歩く前にスキャン",
    showcaseText:
      "スマホでHelloChinaを開き、都市を選び、地図、観光スポット、天気、グルメ、AIガイドを移動中に確認できます。",
    showcaseUrlLabel: "スマホガイド",
    showcaseQrCaption: "出発前にスキャン",
    ...
    footerEyebrow: "制作チーム連絡先",
    footerTitle: "HelloChina 制作チームへの連絡",
    footerText: "協力、フィードバック、旅行サービスの相談は、電話またはメールでご連絡ください。",
    footerPhone: "電話",
    footerEmail: "メール",
    volunteerEyebrow: "ボランティアネットワーク",
    volunteerTitle: "海外からの友人が自信を持って中国を旅できるよう支えます",
    volunteerText: "都市パートナー、言語サポーター、ルートテスターとして HelloChina に参加できます。小さな協力が、より分かりやすく温かいガイドにつながります。",
    volunteerAName: "ボランティア A",
    volunteerALangs: "英語 · 日本語",
    volunteerAText: "英語と日本語が得意で、明るく会話好き。アメリカ交換留学の経験があり、自然な英語で地元の暮らし、屋台、小さなお店を案内しながら、早く街に慣れる手助けができます。",
    volunteerBName: "ボランティア B",
    volunteerBLangs: "英語 · スペイン語",
    volunteerBText: "英語とスペイン語が得意で、熱心でよく笑うタイプ。サッカー文化に詳しく実力もあり、旅を元気に進めながら、中国のキャンパスサッカー体験にも連れて行けます。",
    volunteerCName: "ボランティア C",
    volunteerCLangs: "スペイン語",
    volunteerCText: "スペイン語専攻の3年生で、明るく忍耐強い案内役。リアルな市井生活、夜市のローカルフード、旧市街、歴史の物語を流暢なスペイン語で、聞き取りやすいペースで説明します。",
    volunteerDName: "ボランティア D",
    volunteerDLangs: "英語",
    volunteerDText: "英語専攻の3年生で、標準的な発音と明確な表現が強み。路地歩き、地元の朝食、朝の市場、中国語看板に隠れた面白さを、専門的かつユーモラスに紹介します。",
    volunteerEName: "ボランティア E",
    volunteerELangs: "英語 · スペイン語",
    volunteerEText: "英語とスペイン語が得意で、体力と方向感覚に自信があります。ハイキング、サイクリング、小さなルートが好きな旅行者に向き、山や胡同を歩きながら中国の地質、植物、農村の物語も紹介します。",
    volunteerFName: "ボランティア F",
    volunteerFLangs: "英語",
    volunteerFText: "英語が得意で、複雑な歴史を簡単で面白い英語に変えて話せます。古建築、神話や伝説、現代都市の変化に興味がある方に向き、忍耐強く明るく、写真撮影も得意です。",
    volunteerGName: "ボランティア G",
    volunteerGLangs: "英語",
    volunteerGText: "英語専攻の3年生で、アウトドアと歴史が好き。混雑を避けたい方には、野長城、静かな古寺、山麓でお茶を飲みながら中国の物語を聞くような小さなルートを案内できます。",
    volunteerHName: "ボランティア H",
    volunteerHLangs: "英語",
    volunteerHText: "英語会話が流暢で、穏やかで細やかな性格。子どもや年配の方との旅行、急がないゆったりした日程に向いており、分かりやすい英語で物語を話し、食事や買い物の調整も手伝えます。",
    volunteerCtaTitle: "参加したいですか？",
    volunteerCtaText: "制作チームへ、都市・対応言語・希望する役割をお知らせください",
    volunteerCtaPhone: "電話する",
    volunteerCtaEmail: "メールする",
  ...
  ko: {
    ...
    statLanguages: "UI 언어",
    heroPill: "지도 + 갤러리",
    showcaseEyebrow: "모바일 여행 가이드",
    showcaseTitle: "중국을 걷기 전에 스캔하세요",
    showcaseText:
      "휴대폰에서 HelloChina를 열어 도시를 고르고 지도, 명소, 날씨, 음식, AI 가이드를 여행 중 바로 확인하세요.",
    showcaseUrlLabel: "모바일 가이드",
    showcaseQrCaption: "출발 전에 스캔",
    ...
    footerEyebrow: "제작팀 연락처",
    footerTitle: "HelloChina 제작팀 연락처",
    footerText: "협업, 피드백, 여행 서비스 제안은 전화 또는 이메일로 문의해 주세요.",
    footerPhone: "전화",
    footerEmail: "이메일",
    volunteerEyebrow: "자원봉사 네트워크",
    volunteerTitle: "국제 친구들이 자신 있게 중국을 탐험하도록 도와주세요",
    volunteerText: "도시 버디, 언어 도우미, 경로 테스터로 HelloChina에 참여할 수 있습니다. 작은 기여가 더 명확하고 따뜻한 가이드를 만듭니다.",
    volunteerAName: "자원봉사자 A",
    volunteerALangs: "영어 · 일본어",
    volunteerAText: "영어와 일본어에 능하고 밝고 대화하기를 좋아합니다. 미국 교환 경험이 있어 자연스러운 영어로 현지 생활, 길거리 음식, 재미있는 작은 가게를 소개하며 빠르게 적응하도록 도와줍니다.",
    volunteerBName: "자원봉사자 B",
    volunteerBLangs: "영어 · 스페인어",
    volunteerBText: "영어와 스페인어를 잘하고 열정적이며 잘 웃습니다. 축구를 사랑하고 축구 문화와 실력 모두 뛰어나 여행 내내 활기 있게 이끌며, 원한다면 중국 캠퍼스 축구 문화도 함께 체험할 수 있습니다.",
    volunteerCName: "자원봉사자 C",
    volunteerCLangs: "스페인어",
    volunteerCText: "스페인어 전공 3학년으로 밝고 인내심이 있습니다. 실제 서민 생활, 현지 야시장 음식, 오래된 동네와 역사 이야기를 유창한 스페인어로 천천히 이해하기 쉽게 안내합니다.",
    volunteerDName: "자원봉사자 D",
    volunteerDLangs: "영어",
    volunteerDText: "영어 전공 3학년으로 표준적인 발음과 명확한 표현이 강점입니다. 골목길, 현지 아침 식사, 아침 시장, 중국어 간판 속 재미있는 포인트를 전문적이면서도 유쾌하게 소개합니다.",
    volunteerEName: "자원봉사자 E",
    volunteerELangs: "영어 · 스페인어",
    volunteerEText: "영어와 스페인어에 능하고 체력과 방향감각이 좋습니다. 하이킹, 자전거, 소규모 코스를 좋아하는 여행자에게 잘 맞으며 산과 후통을 걸으며 중국의 지질, 식물, 시골 이야기도 들려줍니다.",
    volunteerFName: "자원봉사자 F",
    volunteerFLangs: "영어",
    volunteerFText: "영어에 능하고 복잡한 역사를 쉽고 재미있는 영어로 설명하는 데 강합니다. 고건축, 신화와 전설, 현대 도시 변화에 관심 있는 여행자에게 좋고, 인내심 많고 잘 웃으며 사진도 잘 찍습니다.",
    volunteerGName: "자원봉사자 G",
    volunteerGLangs: "영어",
    volunteerGText: "영어 전공 3학년으로 야외 활동과 역사를 좋아합니다. 붐비는 명소보다 야생 장성, 조용한 고찰, 산기슭에서 차를 마시며 중국 이야기를 듣는 소규모 코스에 잘 맞습니다.",
    volunteerHName: "자원봉사자 H",
    volunteerHLangs: "영어",
    volunteerHText: "영어 회화가 유창하고 부드럽고 세심한 성격입니다. 아이나 어르신과 함께하는 여행, 서두르지 않는 편안한 일정에 잘 맞으며 쉬운 영어로 이야기를 들려주고 식사와 쇼핑도 조율해 줍니다.",
    volunteerCtaTitle: "참여하고 싶나요?",
    volunteerCtaText: "제작팀에 도시, 사용 언어, 희망하는 자원봉사 역할을 알려 주세요",
    volunteerCtaPhone: "전화하기",
    volunteerCtaEmail: "이메일 보내기",
  ...
  es: {
    ...
    showcaseEyebrow: "Guía móvil de viaje",
    showcaseTitle: "Escanea antes de explorar China",
    showcaseText:
      "Abre HelloChina en tu móvil para elegir ciudad, seguir mapas, ver atracciones, comparar el clima, buscar comida y preguntar al guía de IA.",
    showcaseUrlLabel: "Guía móvil",
    showcaseQrCaption: "Escanea antes de salir",
    ...
    footerEyebrow: "Contacto del equipo",
    footerTitle: "Contacto del equipo de HelloChina",
    footerText: "Escríbenos por teléfono o correo para colaboración, comentarios e ideas de servicios de viaje.",
    footerPhone: "Teléfono",
    footerEmail: "Correo",
    volunteerEyebrow: "Red de voluntarios",
    volunteerTitle: "Ayuda a los amigos internacionales a explorar China con confianza",
    volunteerText: "Únete a HelloChina como acompañante de ciudad, apoyo lingüístico o tester de rutas. Cada aporte hace la guía más clara, cercana y fácil de usar.",
    volunteerAName: "Voluntario A",
    volunteerALangs: "Inglés · Japonés",
    volunteerAText: "Habla inglés y japonés, es abierto y le encanta conversar. Tras un intercambio en Estados Unidos, puede usar inglés natural para ayudarte a adaptarte rápido mientras conoces vida local, comida callejera y pequeñas tiendas.",
    volunteerBName: "Voluntario B",
    volunteerBLangs: "Inglés · Español",
    volunteerBText: "Habla inglés y español, es entusiasta y siempre sonríe. Le encanta el fútbol, conoce bien su cultura y juega muy bien; mantiene el viaje activo y puede llevarte a vivir el fútbol universitario chino.",
    volunteerCName: "Voluntario C",
    volunteerCLangs: "Español",
    volunteerCText: "Estudiante de tercer año de español, alegre y paciente. Puede explicar en español fluido la vida cotidiana real, comida de mercados nocturnos, barrios antiguos e historias locales a un ritmo fácil de seguir.",
    volunteerDName: "Voluntario D",
    volunteerDLangs: "Inglés",
    volunteerDText: "Estudiante de tercer año de inglés, con pronunciación estándar y expresión clara. Disfruta callejones, desayunos locales, mercados matutinos y los detalles curiosos escondidos en letreros chinos.",
    volunteerEName: "Voluntario E",
    volunteerELangs: "Inglés · Español",
    volunteerEText: "Habla inglés y español, tiene buena resistencia y gran sentido de orientación. Es ideal para senderismo, ciclismo y rutas menos conocidas, presentando geología, plantas, hutongs e historias rurales por el camino.",
    volunteerFName: "Voluntario F",
    volunteerFLangs: "Inglés",
    volunteerFText: "Habla inglés y convierte historias complejas en explicaciones sencillas y entretenidas. Es paciente, sonriente, toma buenas fotos y va muy bien con arquitectura antigua, leyendas y cambios urbanos.",
    volunteerGName: "Voluntario G",
    volunteerGLangs: "Inglés",
    volunteerGText: "Estudiante de tercer año de inglés, amante del aire libre y la historia. Si prefieres evitar multitudes, puede guiarte por la Gran Muralla salvaje, templos tranquilos y té al pie de la montaña.",
    volunteerHName: "Voluntario H",
    volunteerHLangs: "Inglés",
    volunteerHText: "Habla inglés con fluidez y tiene un estilo amable y atento. Es ideal para familias, mayores o viajes sin prisa, y puede contar historias en inglés claro y coordinar comida, compras y otros detalles.",
    volunteerCtaTitle: "¿Quieres unirte?",
    volunteerCtaText: "Contacta al equipo y cuéntanos tu ciudad, idiomas y rol de voluntariado preferido",
    volunteerCtaPhone: "Llamar",
    volunteerCtaEmail: "Enviar correo",
  ...
  fr: {
    ...
    showcaseEyebrow: "Guide mobile de voyage",
    showcaseTitle: "Scannez avant d'explorer la Chine",
    showcaseText:
      "Ouvrez HelloChina sur votre téléphone pour choisir une ville, suivre les cartes, consulter les sites, comparer la météo, trouver où manger et interroger le guide IA.",
    showcaseUrlLabel: "Guide mobile",
    showcaseQrCaption: "Scanner avant de partir",
    ...
    footerEyebrow: "Contact de l'équipe",
    footerTitle: "Contact de l'équipe HelloChina",
    footerText: "Contactez-nous par téléphone ou e-mail pour collaborer, donner un avis ou proposer des idées de services de voyage.",
    footerPhone: "Téléphone",
    footerEmail: "E-mail",
    volunteerEyebrow: "Réseau bénévole",
    volunteerTitle: "Aidez les amis internationaux à explorer la Chine avec confiance",
    volunteerText: "Rejoignez HelloChina comme relais local, aide linguistique ou testeur d'itinéraires. Chaque contribution rend le guide plus clair, plus chaleureux et plus utile.",
    volunteerAName: "Bénévole A",
    volunteerALangs: "Anglais · Japonais",
    volunteerAText: "Parle anglais et japonais, avec un tempérament ouvert et bavard. Après un échange aux États-Unis, A peut utiliser un anglais naturel pour vous aider à vous adapter vite tout en découvrant vie locale, street food et petites boutiques.",
    volunteerBName: "Bénévole B",
    volunteerBLangs: "Anglais · Espagnol",
    volunteerBText: "Parle anglais et espagnol, chaleureux et souriant. Passionné de football, il connaît bien cette culture et joue très bien; il garde le voyage dynamique et peut vous faire découvrir le football de campus en Chine.",
    volunteerCName: "Bénévole C",
    volunteerCLangs: "Espagnol",
    volunteerCText: "Étudiant de troisième année en espagnol, joyeux et patient. C explique en espagnol fluide la vraie vie de rue, les snacks de marché nocturne, les vieux quartiers et les récits historiques à un rythme facile à suivre.",
    volunteerDName: "Bénévole D",
    volunteerDLangs: "Anglais",
    volunteerDText: "Étudiant de troisième année en anglais, avec une prononciation standard et une expression claire. D aime les ruelles, les petits-déjeuners locaux, les marchés du matin et les détails cachés dans les enseignes chinoises.",
    volunteerEName: "Bénévole E",
    volunteerELangs: "Anglais · Espagnol",
    volunteerEText: "Parle anglais et espagnol, avec une bonne endurance et un excellent sens de l'orientation. Idéal pour randonnée, vélo et itinéraires rares, E présente aussi géologie, plantes, hutongs et histoires rurales en chemin.",
    volunteerFName: "Bénévole F",
    volunteerFLangs: "Anglais",
    volunteerFText: "Parle anglais et sait transformer une histoire complexe en explication simple et vivante. Patient, souriant et doué pour les photos, F convient bien à l'architecture ancienne, aux légendes et aux transformations urbaines.",
    volunteerGName: "Bénévole G",
    volunteerGLangs: "Anglais",
    volunteerGText: "Étudiant de troisième année en anglais, passionné d'extérieur et d'histoire. Pour éviter la foule, G peut guider vers la Grande Muraille sauvage, un temple calme ou un thé au pied de la montagne avec des histoires chinoises.",
    volunteerHName: "Bénévole H",
    volunteerHLangs: "Anglais",
    volunteerHText: "Parle anglais couramment, avec un style doux et attentif. H convient aux familles, aux seniors et aux voyages tranquilles, raconte clairement les histoires en anglais et aide à coordonner repas, achats et détails pratiques.",
    volunteerCtaTitle: "Envie de participer ?",
    volunteerCtaText: "Contactez l'équipe avec votre ville, vos langues et le rôle bénévole souhaité",
    volunteerCtaPhone: "Appeler",
    volunteerCtaEmail: "Envoyer un e-mail",
  ...
  ar: {
    ...
    heroPill: "خريطة + معرض",
    showcaseEyebrow: "دليل سفر على الهاتف",
    showcaseTitle: "امسح الرمز قبل استكشاف الصين",
    showcaseText:
      "افتح HelloChina على هاتفك لاختيار مدينة، وتتبع الخرائط، ومراجعة المعالم والطقس والطعام، وسؤال دليل الذكاء الاصطناعي أثناء الرحلة.",
    showcaseUrlLabel: "دليل الهاتف",
    showcaseQrCaption: "امسح قبل الانطلاق",
    ...
    footerEyebrow: "تواصل مع الفريق",
    footerTitle: "بيانات تواصل فريق HelloChina",
    footerText: "تواصل معنا عبر الهاتف أو البريد الإلكتروني للتعاون والملاحظات وأفكار خدمات السفر.",
    footerPhone: "الهاتف",
    footerEmail: "البريد الإلكتروني",
    volunteerEyebrow: "شبكة المتطوعين",
    volunteerTitle: "ساعد الأصدقاء الدوليين على استكشاف الصين بثقة",
    volunteerText: "انضم إلى HelloChina كرفيق مدينة أو مساعد لغوي أو مختبر مسارات. كل مساهمة تجعل الدليل أوضح وأكثر ترحيباً وأسهل استخداماً.",
    volunteerAName: "المتطوع A",
    volunteerALangs: "الإنجليزية · اليابانية",
    volunteerAText: "يتقن الإنجليزية واليابانية، وهو منفتح ويحب الحديث. بعد تجربة تبادل في الولايات المتحدة، يستطيع استخدام إنجليزية طبيعية لمساعدتك على التأقلم بسرعة أثناء استكشاف الحياة المحلية وأطعمة الشارع والمتاجر الصغيرة.",
    volunteerBName: "المتطوع B",
    volunteerBLangs: "الإنجليزية · الإسبانية",
    volunteerBText: "يتقن الإنجليزية والإسبانية، ودود وكثير الابتسام. يحب كرة القدم ويفهم ثقافتها جيدًا ومستواه عالٍ، فيجعل الرحلة مليئة بالطاقة ويمكنه مرافقتك لتجربة كرة القدم الجامعية في الصين.",
    volunteerCName: "المتطوع C",
    volunteerCLangs: "الإسبانية",
    volunteerCText: "طالب في السنة الثالثة بتخصص الإسبانية، مرح وصبور. يستطيع شرح الحياة الشعبية الحقيقية وأطعمة الأسواق الليلية والأحياء القديمة والقصص التاريخية بإسبانية سلسة وبإيقاع مريح.",
    volunteerDName: "المتطوع D",
    volunteerDLangs: "الإنجليزية",
    volunteerDText: "طالب في السنة الثالثة بتخصص الإنجليزية، نطقه قياسي وتعبيره واضح. يحب التجول في الأزقة وتذوق الإفطار المحلي وزيارة أسواق الصباح وشرح التفاصيل الطريفة في اللافتات الصينية.",
    volunteerEName: "المتطوع E",
    volunteerELangs: "الإنجليزية · الإسبانية",
    volunteerEText: "يتقن الإنجليزية والإسبانية، ولياقته جيدة وحسه بالاتجاه قوي. مناسب للمشي وركوب الدراجات والمسارات غير الشائعة، ويشرح أثناء الطريق جيولوجيا الصين ونباتاتها والأزقة وقصص الريف.",
    volunteerFName: "المتطوع F",
    volunteerFLangs: "الإنجليزية",
    volunteerFText: "يتقن الإنجليزية ويجيد تحويل التاريخ المعقد إلى قصص بسيطة وممتعة. صبور ومبتسم ويجيد التصوير، ومناسب للمهتمين بالعمارة القديمة والأساطير وتغير المدن الحديثة.",
    volunteerGName: "المتطوع G",
    volunteerGLangs: "الإنجليزية",
    volunteerGText: "طالب في السنة الثالثة بتخصص الإنجليزية، يحب الهواء الطلق والتاريخ. إذا كنت لا تريد الزحام، يمكنه مرافقتك إلى السور البري أو معبد هادئ أو شرب الشاي أسفل الجبل مع قصص عن الصين.",
    volunteerHName: "المتطوع H",
    volunteerHLangs: "الإنجليزية",
    volunteerHText: "يتحدث الإنجليزية بطلاقة، وشخصيته لطيفة ودقيقة. مناسب للعائلات وكبار السن والرحلات الهادئة غير المستعجلة، ويشرح القصص بإنجليزية بسيطة ويساعد في تنسيق الطعام والتسوق والتفاصيل الأخرى.",
    volunteerCtaTitle: "هل ترغب في الانضمام؟",
    volunteerCtaText: "تواصل مع فريق الإنتاج وأخبرنا بمدينتك ولغاتك والدور التطوعي الذي تفضله",
    volunteerCtaPhone: "اتصل بنا",
    volunteerCtaEmail: "راسلنا",
...
const weatherUiContent = {
  en: {
    ...
    liveSync: "Updates automatically while this page stays open.",
    now: "Now",
  ...
  ja: {
    ...
    refreshNow: "今すぐ更新",
    refreshing: "更新中...",
    liveSync: "このページを開いている間は自動で更新されます。",
    now: "現在",
    nextDays: "今後5日",
    feelsLike: "体感温度",
    wind: "風速",
  ...
  ko: {
    ...
    refreshNow: "지금 새로고침",
    refreshing: "새로고침 중...",
    liveSync: "이 페이지를 열어 두면 날씨가 자동으로 갱신됩니다.",
    now: "현재",
    nextDays: "앞으로 5일",
    feelsLike: "체감 온도",
    wind: "풍속",
  ...
  es: {
    ...
    liveSync: "Se actualiza automáticamente mientras la página siga abierta.",
    now: "Ahora",
  ...
  fr: {
    ...
    liveSync: "La météo se met à jour automatiquement tant que la page reste ouverte.",
    now: "Maintenant",
  ...
  ar: {
    ...
    liveSync: "يتم تحديث الطقس تلقائيًا ما دامت الصفحة مفتوحة.",
    now: "الآن",
...
const travelAdviceText = {
  en: {
    ...
    stormHold: "If the weather turns unstable, leave extra buffer time and avoid relying on one fully outdoor sequence.",
    swingCare: "There is a noticeable temperature swing today, so it helps to plan layers rather than a single light outfit.",
    calmCity: "Conditions look fairly even, so the day can stay open and walk-heavy without much adjustment.",
    ...
    shadeCap: "A cap or sunglasses will help on the brighter stretches.",
  ...
  zh: {
    ...
    stormHold: "如果天气转得不稳定，最好多留一点缓冲时间，不要把整段行程都压在纯户外点位上。",
    swingCare: "今天昼夜温差比较明显，比起穿单一的一套，更适合分层准备。",
    calmCity: "整体条件比较平稳，可以把步行感更强的城市段正常保留。",
    umbrella: "雨伞或轻便防水外套。",
    sun: "防晒、饮水和更轻的上衣。",
    layer: "早晚多带一层薄外套。",
    wind: "一件轻薄防风层。",
    shadeCap: "帽子或墨镜会让开阔路段更舒服。",
  ...
  ja: {
    ...
    stormHold: "天気が不安定に振れるなら、余白を持たせて屋外だけに寄せすぎない方が安全です。",
    swingCare: "今日は気温差が出やすいので、軽装一枚より重ね着の方が調整しやすいです。",
    calmCity: "全体として安定しているので、歩く時間をしっかり取る回り方でも進めやすいです。",
    umbrella: "折りたたみ傘か軽いレインシェル。",
    sun: "日焼け対策、水分、軽めのトップス。",
    layer: "朝晩用に薄手の上着を一枚。",
    wind: "軽い防風レイヤー。",
    shadeCap: "帽子やサングラスがあると開けた区間が楽です。",
    light: "荷物は軽めにして歩きやすく。",
  ...
  ko: {
    ...
    stormHold: "날씨가 불안정해질 수 있으면 여유 시간을 두고, 완전히 야외 위주로만 짜지 않는 편이 안전합니다.",
    swingCare: "오늘은 기온 차가 제법 있어 한 벌보다 레이어드가 더 편합니다.",
    calmCity: "전체 조건이 안정적이라 걸어 다니는 비중이 높은 일정도 무리 없이 소화하기 좋습니다.",
    umbrella: "우산이나 가벼운 방수 겉옷.",
    sun: "자외선 차단, 물, 가벼운 상의.",
    layer: "아침저녁용 얇은 겉옷 한 겹.",
    wind: "가벼운 방풍 레이어.",
    shadeCap: "모자나 선글라스가 있으면 열린 구간이 더 편합니다.",
  ...
  es: {
    ...
    stormHold: "Si el tiempo se vuelve inestable, conviene dejar más margen y no depender de un tramo completamente al aire libre.",
    swingCare: "Hoy hay una diferencia térmica clara, así que es mejor vestirse por capas que con una sola prenda ligera.",
    calmCity: "Las condiciones son bastante estables, así que se puede mantener sin problema una jornada más caminable.",
    ...
    shadeCap: "Una gorra o gafas de sol ayudarán en los tramos más abiertos.",
  ...
  fr: {
    ...
    stormHold: "Si le temps devient instable, gardez plus de marge et évitez de miser toute la journée sur un enchaînement 100% extérieur.",
    swingCare: "L'écart de température est marqué aujourd'hui, donc les couches seront plus utiles qu'une tenue unique légère.",
    calmCity: "Les conditions sont assez stables, donc une journée plus axée sur la marche reste confortable.",
    ...
    shadeCap: "Une casquette ou des lunettes de soleil aideront sur les portions ouvertes.",
  ...
  ar: {
    ...
    stormHold: "إذا أصبح الطقس غير مستقر فمن الأفضل ترك هامش إضافي وعدم الاعتماد على تسلسل خارجي بالكامل.",
    swingCare: "هناك فرق حراري واضح اليوم، لذلك سيكون اللبس على طبقات أفضل من الاكتفاء بقطعة خفيفة واحدة.",
    calmCity: "الظروف مستقرة نسبيًا، لذلك يمكن الإبقاء على يوم يعتمد أكثر على المشي براحة.",
    ...
    shadeCap: "ستساعد القبعة أو النظارات الشمسية في المقاطع المفتوحة.",
...
function weatherCacheIsFresh(entry) {
  return Boolean(entry && Date.now() - entry.fetchedAt < WEATHER_CACHE_TTL_MS);
}
...
function formatWeatherUpdatedTime(dateString) {
  if (!dateString) return "";
  const parsedDate = typeof dateString === "number" ? new Date(dateString) : new Date(`${dateString}:00+08:00`);
  return new Intl.DateTimeFormat(localeForLanguage(), {
    timeZone: "Asia/Shanghai",
    hour: "2-digit",
    minute: "2-digit"
...
function uniqueAdviceLines(lines) {
  return [...new Set(lines.filter(Boolean))];
}

function combineAdviceLines(lines, limit = 2) {
...
function buildTravelPlanner(weather, city, dayIndex = 0) {
  ...
  if (flags.stormy) {
    weatherNotes.push(advice.stormHold);
  }
  if (flags.rainy) {
    weatherNotes.push(advice.rainCompact);
  }
  if (flags.windy) {
    weatherNotes.push(advice.windCare);
  }
  if (flags.hot) {
    weatherNotes.push(advice.hotShade);
  }
  if (flags.cold) {
    weatherNotes.push(advice.coldSteady);
  }
  if (flags.tempSwing) {
    weatherNotes.push(advice.swingCare);
  }
  if (!weatherNotes.length) {
    weatherNotes.push(flags.night ? advice.nightGo : flags.clear ? advice.clearGo : advice.calmCity);
  } else if (flags.clear && !flags.rainy && !flags.windy && !flags.hot && !flags.cold) {
    weatherNotes.push(advice.clearGo);
  } else if (!flags.rainy && !flags.windy && !flags.hot && !flags.cold) {
    weatherNotes.push(advice.calmCity);
  }

  if (flags.rainy || flags.stormy) {
    carryNotes.push(advice.umbrella);
  }
  if (flags.hot) {
    carryNotes.push(advice.sun);
  }
  if (flags.clear && !flags.night && !flags.rainy) {
    carryNotes.push(advice.shadeCap);
  }
  if (flags.windy) {
    carryNotes.push(advice.wind);
  }
  if (flags.cold || flags.tempSwing) {
    carryNotes.push(advice.layer);
  }
  if (!carryNotes.length) {
    carryNotes.push(advice.light);
  }

  if (flags.rainy || flags.hot) {
    timingNotes.push(advice.earlyLate);
  }
  if (flags.clear && flags.mild && !flags.night) {
    timingNotes.push(advice.lateMorning);
  }
  if (flags.clear) {
    timingNotes.push(advice.goldenHour);
  }
...
function refreshWeatherForCity(city, options = {}) {
  const force = options.force === true;
  const cacheEntry = weatherRuntime.cache[city.id];
  if ((!force && weatherCacheIsFresh(cacheEntry)) || weatherRuntime.pending[city.id]) {
    return Promise.resolve(cacheEntry?.data || null);
  }
...
function ensureCityWeather(city) {
  return refreshWeatherForCity(city);
}

function refreshActiveCityWeather(force = false) {
  const city = activeCity();
  if (!city) return Promise.resolve(null);
  return refreshWeatherForCity(city, { force });
}

function setupWeatherAutoRefresh() {
  if (weatherRuntime.timerId) return;

  weatherRuntime.timerId = window.setInterval(() => {
...
function renderWeatherSection() {
  ...
  const isRefreshing = Boolean(weatherRuntime.pending[city.id]);
