const uiContent = {
  en: {
    ...
    showcaseEyebrow: "Start on mobile",
    showcaseTitle: "Scan and carry HelloChina with you.",
    showcaseText:
      "Open the guide on your phone, choose a city, and keep maps, attractions, weather, food tips, and AI help close while you travel.",
  ...
  zh: {
    ...
    statLanguages: "界面语言",
    heroPill: "地图 + 图库",
    showcaseEyebrow: "手机端入口",
    showcaseTitle: "扫码把 HelloChina 带在身边。",
    showcaseText:
      "用手机打开导览后，可以随时查看城市地图、景点、天气、美食建议和 AI 地陪，让旅途更顺手。",
  ...
  ja: {
    ...
    statLanguages: "UI言語",
    heroPill: "地図 + ギャラリー",
    showcaseEyebrow: "スマホで使う",
    showcaseTitle: "スキャンしてHelloChinaを旅先へ。",
    showcaseText:
      "スマホでガイドを開けば、都市地図、観光スポット、天気、グルメ情報、AIガイドを移動中にも確認できます。",
  ...
  ko: {
    ...
    statLanguages: "UI 언어",
    heroPill: "지도 + 갤러리",
    showcaseEyebrow: "모바일로 시작",
    showcaseTitle: "스캔하고 HelloChina를 여행에 가져가세요.",
    showcaseText:
      "휴대폰에서 가이드를 열고 도시 지도, 명소, 날씨, 음식 추천, AI 도움을 이동 중에도 바로 확인하세요.",
  ...
  es: {
    ...
    showcaseEyebrow: "Empieza en el móvil",
    showcaseTitle: "Escanea y lleva HelloChina contigo.",
    showcaseText:
      "Abre la guía en tu móvil, elige una ciudad y lleva contigo mapas, atracciones, clima, comida y ayuda de IA durante el viaje.",
  ...
  fr: {
    ...
    showcaseEyebrow: "Commencer sur mobile",
    showcaseTitle: "Scannez et gardez HelloChina avec vous.",
    showcaseText:
      "Ouvrez le guide sur votre téléphone, choisissez une ville et gardez cartes, sites, météo, cuisine et aide IA sous la main pendant le voyage.",
  ...
  ar: {
    ...
    heroPill: "خريطة + معرض",
    showcaseEyebrow: "ابدأ على الهاتف",
    showcaseTitle: "امسح الرمز وخذ HelloChina معك.",
    showcaseText:
      "افتح الدليل على هاتفك واختر مدينة، واحتفظ بالخرائط والمعالم والطقس ونصائح الطعام ومساعدة الذكاء الاصطناعي أثناء الرحلة.",
