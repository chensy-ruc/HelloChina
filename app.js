const uiContent = {
  en: {
    ...
    showcaseEyebrow: "Showcase access",
    showcaseTitle: "Scan to open HelloChina on your phone.",
    showcaseText:
      "Use this QR code in presentations, booth displays, or class demos. It points to the public GitHub Pages address for the project.",
    showcaseUrlLabel: "Public page",
    showcaseQrCaption: "Scan for the live guide",
  ...
  zh: {
    ...
    statLanguages: "界面语言",
    heroPill: "地图 + 图库",
    showcaseEyebrow: "展示入口",
    showcaseTitle: "扫码即可在手机上打开 HelloChina。",
    showcaseText:
      "这个二维码适合放在路演、展台或课堂展示中使用，指向项目的 GitHub Pages 公共页面。",
    showcaseUrlLabel: "公开页面",
    showcaseQrCaption: "扫码进入实时导览",
  ...
  ja: {
    ...
    statLanguages: "UI言語",
    heroPill: "地図 + ギャラリー",
    showcaseEyebrow: "展示用アクセス",
    showcaseTitle: "QRコードでHelloChinaをスマホで開けます。",
    showcaseText:
      "発表、展示ブース、授業デモで使いやすいQRコードです。プロジェクトのGitHub Pages公開ページにつながります。",
    showcaseUrlLabel: "公開ページ",
    showcaseQrCaption: "スキャンしてライブガイドへ",
  ...
  ko: {
    ...
    statLanguages: "UI 언어",
    heroPill: "지도 + 갤러리",
    showcaseEyebrow: "전시용 접속",
    showcaseTitle: "QR 코드를 스캔해 휴대폰에서 HelloChina를 여세요.",
    showcaseText:
      "발표, 부스 전시, 수업 데모에서 바로 사용할 수 있는 QR 코드입니다. 프로젝트의 GitHub Pages 공개 페이지로 연결됩니다.",
    showcaseUrlLabel: "공개 페이지",
    showcaseQrCaption: "스캔해서 실시간 가이드 열기",
  ...
  es: {
    ...
    showcaseEyebrow: "Acceso para presentación",
    showcaseTitle: "Escanea para abrir HelloChina en tu móvil.",
    showcaseText:
      "Usa este código QR en presentaciones, stands o demos de clase. Apunta a la página pública de GitHub Pages del proyecto.",
    showcaseUrlLabel: "Página pública",
    showcaseQrCaption: "Escanea para abrir la guía",
  ...
  fr: {
    ...
    showcaseEyebrow: "Accès de démonstration",
    showcaseTitle: "Scannez pour ouvrir HelloChina sur mobile.",
    showcaseText:
      "Ce QR code est prévu pour les présentations, stands et démonstrations en classe. Il pointe vers la page GitHub Pages publique du projet.",
    showcaseUrlLabel: "Page publique",
    showcaseQrCaption: "Scanner pour ouvrir le guide",
  ...
  ar: {
    ...
    heroPill: "خريطة + معرض",
    showcaseEyebrow: "دخول للعرض",
    showcaseTitle: "امسح الرمز لفتح HelloChina على هاتفك.",
    showcaseText:
      "يمكن استخدام رمز QR هذا في العروض أو الأجنحة أو عروض الصف، وهو يشير إلى صفحة GitHub Pages العامة للمشروع.",
    showcaseUrlLabel: "الصفحة العامة",
    showcaseQrCaption: "امسح لفتح الدليل المباشر",
