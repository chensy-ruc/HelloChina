const uiContent = {
  ...
  zh: {
    ...
    volunteerTitle: "和国际友人一起，把中国旅行讲得更清楚。",
  ...
  ja: {
    ...
    volunteerTitle: "海外からの友人が安心して中国を旅できるよう支えます。",
  ...
  ko: {
    ...
    volunteerTitle: "국제 친구들이 중국을 더 편하게 여행하도록 함께 도와주세요.",
  ...
  es: {
    ...
    volunteerTitle: "Ayuda a que amigos internacionales exploren China con más confianza.",
  ...
  fr: {
    ...
    volunteerTitle: "Aidez les amis internationaux à explorer la Chine en confiance.",
