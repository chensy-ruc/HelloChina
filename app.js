const uiContent = {
  en: {
    ...
    volunteerAText: "Outgoing and easy to talk with, great for local lifestyle, street snacks, and small shops.",
    volunteerBName: "Volunteer B",
    volunteerBLangs: "English · Spanish",
    volunteerBText: "Energetic and football-loving, ideal for campus football culture and lively city walks.",
    volunteerCName: "Volunteer C",
    volunteerCLangs: "Spanish",
    volunteerCText: "Patient Spanish guide for night markets, old districts, real local life, and history stories.",
    volunteerDName: "Volunteer D",
    volunteerDLangs: "English",
    volunteerDText: "Clear English speaker who enjoys breakfast markets, alley walks, signs, and everyday stories.",
    volunteerEName: "Volunteer E",
    volunteerELangs: "English · Spanish",
    volunteerEText: "Strong sense of direction, perfect for hiking, cycling, hutongs, nature, and niche routes.",
    volunteerFName: "Volunteer F",
    volunteerFLangs: "English",
    volunteerFText: "Explains history in simple English and is good with architecture, legends, city change, and photos.",
    volunteerGName: "Volunteer G",
    volunteerGLangs: "English",
    volunteerGText: "Outdoor and history fan for less crowded routes, wild Great Wall walks, temples, and tea stops.",
    volunteerHName: "Volunteer H",
    volunteerHLangs: "English",
    volunteerHText: "Gentle and careful, helpful for families, seniors, relaxed schedules, dining, and shopping details.",
  ...
  zh: {
    ...
    volunteerAText: "开朗健谈，适合带你了解本地生活方式、街头小吃和有趣小店。",
    volunteerBName: "志愿者 B",
    volunteerBLangs: "英语 · 西班牙语",
    volunteerBText: "热情有活力，热爱足球，适合体验校园足球文化和轻松城市漫步。",
    volunteerCName: "志愿者 C",
    volunteerCLangs: "西班牙语",
    volunteerCText: "耐心的西语向导，适合夜市小吃、老城区、市井生活和历史故事。",
    volunteerDName: "志愿者 D",
    volunteerDLangs: "英语",
    volunteerDText: "英语表达清晰，喜欢早餐市场、街巷漫步、中文招牌和日常故事。",
    volunteerEName: "志愿者 E",
    volunteerELangs: "英语 · 西班牙语",
    volunteerEText: "方向感强、体力好，适合徒步、骑行、胡同、自然和小众路线。",
    volunteerFName: "志愿者 F",
    volunteerFLangs: "英语",
    volunteerFText: "擅长用简单英文讲历史，适合古建筑、神话传说、城市变迁和拍照。",
    volunteerGName: "志愿者 G",
    volunteerGLangs: "英语",
    volunteerGText: "喜欢户外和历史，适合小众路线、野长城、古寺和山脚茶歇。",
    volunteerHName: "志愿者 H",
    volunteerHLangs: "英语",
    volunteerHText: "温柔细心，适合家庭、老人、轻松行程以及餐饮购物等细节协调。",
  ...
  ja: {
    ...
    volunteerAText: "明るく話しやすく、地元の暮らし、屋台、小さなお店を楽しみたい方に向いています。",
    volunteerBName: "ボランティア B",
    volunteerBLangs: "英語 · スペイン語",
    volunteerBText: "活発でサッカー好き。キャンパスサッカー文化や元気な街歩きにぴったりです。",
    volunteerCName: "ボランティア C",
    volunteerCLangs: "スペイン語",
    volunteerCText: "夜市、旧市街、リアルな市井生活、歴史の話をスペイン語で丁寧に案内します。",
    volunteerDName: "ボランティア D",
    volunteerDLangs: "英語",
    volunteerDText: "聞き取りやすい英語で、朝市、路地歩き、中国語看板、日常の物語を紹介します。",
    volunteerEName: "ボランティア E",
    volunteerELangs: "英語 · スペイン語",
    volunteerEText: "方向感覚と体力があり、ハイキング、自転車、胡同、自然、小さなルートに向いています。",
    volunteerFName: "ボランティア F",
    volunteerFLangs: "英語",
    volunteerFText: "歴史をやさしい英語で説明し、古建築、伝説、都市の変化、写真も得意です。",
    volunteerGName: "ボランティア G",
    volunteerGLangs: "英語",
    volunteerGText: "アウトドアと歴史が好きで、混雑しにくい道、野長城、古寺、お茶休憩に向いています。",
    volunteerHName: "ボランティア H",
    volunteerHLangs: "英語",
    volunteerHText: "穏やかで細やか。家族や年配の方、ゆったりした日程、食事や買い物の相談に向いています。",
  ...
  ko: {
    ...
    volunteerAText: "밝고 대화하기 편해 현지 생활, 길거리 음식, 작은 가게 탐방에 잘 맞습니다.",
    volunteerBName: "자원봉사자 B",
    volunteerBLangs: "영어 · 스페인어",
    volunteerBText: "활기차고 축구를 좋아해 캠퍼스 축구 문화와 생동감 있는 도시 산책에 좋습니다.",
    volunteerCName: "자원봉사자 C",
    volunteerCLangs: "스페인어",
    volunteerCText: "야시장, 오래된 동네, 실제 생활 모습, 역사 이야기를 스페인어로 차분히 안내합니다.",
    volunteerDName: "자원봉사자 D",
    volunteerDLangs: "영어",
    volunteerDText: "명확한 영어로 아침 시장, 골목 산책, 중국어 간판, 일상 이야기를 소개합니다.",
    volunteerEName: "자원봉사자 E",
    volunteerELangs: "영어 · 스페인어",
    volunteerEText: "방향감각과 체력이 좋아 하이킹, 자전거, 후통, 자연, 소규모 코스에 적합합니다.",
    volunteerFName: "자원봉사자 F",
    volunteerFLangs: "영어",
    volunteerFText: "쉬운 영어로 역사를 설명하며 고건축, 전설, 도시 변화, 사진 촬영에도 강합니다.",
    volunteerGName: "자원봉사자 G",
    volunteerGLangs: "영어",
    volunteerGText: "야외 활동과 역사를 좋아해 한적한 코스, 야생 장성, 고찰, 차 한잔 코스에 좋습니다.",
    volunteerHName: "자원봉사자 H",
    volunteerHLangs: "영어",
    volunteerHText: "부드럽고 세심해 가족, 어르신, 여유로운 일정, 식사와 쇼핑 조율에 잘 맞습니다.",
  ...
  es: {
    ...
    volunteerAText: "Abierto y conversador, ideal para vida local, comida callejera y pequeñas tiendas.",
    volunteerBName: "Voluntario B",
    volunteerBLangs: "Inglés · Español",
    volunteerBText: "Enérgico y fan del fútbol, perfecto para cultura de fútbol universitario y paseos activos.",
    volunteerCName: "Voluntario C",
    volunteerCLangs: "Español",
    volunteerCText: "Guía paciente en español para mercados nocturnos, barrios antiguos, vida local e historia.",
    volunteerDName: "Voluntario D",
    volunteerDLangs: "Inglés",
    volunteerDText: "Habla inglés claro y disfruta mercados de desayuno, callejones, letreros y relatos cotidianos.",
    volunteerEName: "Voluntario E",
    volunteerELangs: "Inglés · Español",
    volunteerEText: "Buen sentido de orientación, ideal para senderismo, ciclismo, hutongs, naturaleza y rutas poco conocidas.",
    volunteerFName: "Voluntario F",
    volunteerFLangs: "Inglés",
    volunteerFText: "Explica historia en inglés sencillo y sabe de arquitectura, leyendas, cambios urbanos y fotos.",
    volunteerGName: "Voluntario G",
    volunteerGLangs: "Inglés",
    volunteerGText: "Amante del aire libre y la historia, bueno para rutas tranquilas, Gran Muralla salvaje, templos y té.",
    volunteerHName: "Voluntario H",
    volunteerHLangs: "Inglés",
    volunteerHText: "Amable y cuidadoso, útil para familias, mayores, planes relajados, comida y compras.",
  ...
  fr: {
    ...
    volunteerAText: "Ouvert et facile à aborder, idéal pour la vie locale, les snacks de rue et les petites boutiques.",
    volunteerBName: "Bénévole B",
    volunteerBLangs: "Anglais · Espagnol",
    volunteerBText: "Énergique et passionné de football, parfait pour la culture football universitaire et les balades vivantes.",
    volunteerCName: "Bénévole C",
    volunteerCLangs: "Espagnol",
    volunteerCText: "Guide patient en espagnol pour marchés de nuit, vieux quartiers, vie locale et récits historiques.",
    volunteerDName: "Bénévole D",
    volunteerDLangs: "Anglais",
    volunteerDText: "Anglais clair, à l'aise avec marchés du matin, ruelles, enseignes chinoises et histoires du quotidien.",
    volunteerEName: "Bénévole E",
    volunteerELangs: "Anglais · Espagnol",
    volunteerEText: "Très bon sens de l'orientation, adapté à la randonnée, au vélo, aux hutongs, à la nature et aux itinéraires rares.",
    volunteerFName: "Bénévole F",
    volunteerFLangs: "Anglais",
    volunteerFText: "Explique l'histoire en anglais simple, avec un intérêt pour architecture, légendes, villes et photos.",
    volunteerGName: "Bénévole G",
    volunteerGLangs: "Anglais",
    volunteerGText: "Passionné d'extérieur et d'histoire, idéal pour routes calmes, Grande Muraille sauvage, temples et thé.",
    volunteerHName: "Bénévole H",
    volunteerHLangs: "Anglais",
    volunteerHText: "Doux et attentif, utile pour familles, seniors, rythmes détendus, repas et achats.",
  ...
  ar: {
    ...
    volunteerAText: "شخص منفتح وسهل الحديث، مناسب للحياة المحلية وأطعمة الشارع والمتاجر الصغيرة.",
    volunteerBName: "المتطوع B",
    volunteerBLangs: "الإنجليزية · الإسبانية",
    volunteerBText: "مفعم بالطاقة ويحب كرة القدم، مناسب لثقافة كرة القدم الجامعية والجولات النشيطة.",
    volunteerCName: "المتطوع C",
    volunteerCLangs: "الإسبانية",
    volunteerCText: "مرشد صبور بالإسبانية للأسواق الليلية والأحياء القديمة والحياة المحلية وقصص التاريخ.",
    volunteerDName: "المتطوع D",
    volunteerDLangs: "الإنجليزية",
    volunteerDText: "يتحدث الإنجليزية بوضوح ويحب أسواق الإفطار والأزقة واللافتات الصينية وقصص الحياة اليومية.",
    volunteerEName: "المتطوع E",
    volunteerELangs: "الإنجليزية · الإسبانية",
    volunteerEText: "اتجاهه قوي ولياقته جيدة، مناسب للمشي وركوب الدراجات والأزقة والطبيعة والمسارات غير الشائعة.",
    volunteerFName: "المتطوع F",
    volunteerFLangs: "الإنجليزية",
    volunteerFText: "يشرح التاريخ بإنجليزية بسيطة، ومناسب للعمارة القديمة والأساطير وتغير المدن والتصوير.",
    volunteerGName: "المتطوع G",
    volunteerGLangs: "الإنجليزية",
    volunteerGText: "يحب الهواء الطلق والتاريخ، مناسب للمسارات الهادئة والسور البري والمعابد القديمة واستراحات الشاي.",
    volunteerHName: "المتطوع H",
    volunteerHLangs: "الإنجليزية",
    volunteerHText: "لطيف ودقيق، مناسب للعائلات وكبار السن والجداول الهادئة وتنسيق الطعام والتسوق.",
